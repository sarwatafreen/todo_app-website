...
Secure, user-scoped REST API with JWT authentication and Neon PostgreSQL storage.

## Overview

This backend API provides a secure, stateless REST API that enforces JWT authentication, user ownership, and persistent task storage in Neon PostgreSQL using SQLModel. The API implements user-scoped endpoints with strict authentication and authorization controls to ensure data isolation between users.
