...
def get_conversation_by_id(conversation_id: str, user_id: str, session: Session) -> Optional[Conversation]:
    """
...
def create_new_conversation(user_id: str, title: Optional[str], session: Session) -> Conversation:
    """
...
def get_messages_for_conversation(conversation_id: str, user_id: str, session: Session) -> List[Message]:
    """
